...
return array(
	//'配置项'=>'配置值'
	//'MODULE_ALLOW_LIST' => array('Home','LuckyNum','Aoyun','Activity','Xiaodai','Test'),//模块列表
	...
	*/
	...
	'TMPL_ACTION_ERROR'     =>  './Public/resource/system/jump.xyh', // error tpl
    'TMPL_ACTION_SUCCESS'   => './Public/resource/system/jump.xyh', //  success tpl
    'TMPL_EXCEPTION_FILE'   => './Public/resource/system/exception.xyh', //exception tpl
